...
.PHONY: k6-observability-init k6-up k6-down k6-smoke k6-seed k6-seed-cleanup k6-mixed-read k6-dry-mixed-read k6-global-search k6-scenario k6-env-init \
	k6-test k6-test-syntax k6-test-runner k6-test-seed k6-test-summary k6-test-single-api k6-test-cache k6-test-options k6-test-compose k6-test-observability
...
k6-observability-init:
	@docker compose up -d --wait postgres redis
	@docker compose exec -T postgres sh -c \
		'psql -v ON_ERROR_STOP=1 -U "$$POSTGRES_USER" -d "$$POSTGRES_DB" -f /docker-entrypoint-initdb.d/10-observability.sql'

k6-up: k6-env-init k6-observability-init
...
k6-test-observability:
	@ENV_FILE=performance/k6/env/monitoring.env.example bash performance/k6/scripts/verify-observability.sh
