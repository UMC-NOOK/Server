                ...
                mockMvc.perform(
                        ...
                        .andDo(documentWithAuth(
                                ...
                                responseFields(ApiResponseSnippet.withResult(
                                        ...
                                        fieldWithPath("result.timelinePreview.dateGroups[].showYear").type(JsonFieldType.BOOLEAN).description("해당 서재에서 해당 연도의 첫 기록 날짜이면 true"),
                ...
                mockMvc.perform(
                        ...
                        .andDo(documentWithAuth(
                                ...
                                responseFields(ApiResponseSnippet.withResult(
                                        ...
                                        fieldWithPath("result.dateGroups[].showYear").type(JsonFieldType.BOOLEAN).description("해당 서재에서 해당 연도의 첫 기록 날짜이면 true"),
