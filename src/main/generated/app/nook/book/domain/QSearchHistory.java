...
public class QSearchHistory extends EntityPathBase<SearchHistory> {
    ...
    private static final long serialVersionUID = 1437528579L;
    ...
    public final EnumPath<app.nook.book.domain.enums.SearchType> searchType = createEnum("searchType", app.nook.book.domain.enums.SearchType.class);
